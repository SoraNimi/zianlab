...
for j in range(0, layer0_shape[1]):
    for i in range(0, layer0_shape[0]):
        output_file.write("xl0b%dc%d l0bl%d vdd x%s x%sb CELLD r1=%se3 r0=%se3\n"
                          % (j, i, j, i, i,
                             ((10000 + Rh1[j * 28 + i]) if neuron[0][i][j] == 1 else (900 + Rl1[j * 28 + i])),
                             ((900 + Rl1[j * 28 + i]) if neuron[0][i][j] == 1 else (10000 + Rh1[j * 28 + i]))))
...
for j in range(0, layer1_shape[1]):
    for i in range(0, layer1_shape[0]):
        ...
        j, i, j, i, i, ((10000 + Rh2[j * 28 + i]) if neuron[2][i][j] == 1 else (900 + Rl2[j * 28 + i])),
        ((900 + Rl2[j * 28 + i]) if neuron[2][i][j] == 1 else (10000 + Rh2[j * 28 + i]))))
...
for j in range(0, layer2_shape[1]):
    for i in range(0, layer2_shape[0]):
        ...
        j, i, j, i, i, ((10000 + Rh3[j * 28 + i]) if neuron[4][i][j] == 1 else (900 + Rl3[j * 28 + i])),
        ((900 + Rl3[j * 28 + i]) if neuron[4][i][j] == 1 else (10000 + Rh3[j * 28 + i]))))
...
for j in range(0, layer3_shape[1]):
    for i in range(0, layer3_shape[0]):
        ...
        j, i, j, i, i, ((10000 + Rh4[j * 28 + i]) if neuron[6][i][j] == 1 else (900 + Rl4[j * 28 + i])),
        ((900 + Rl4[j * 28 + i]) if neuron[6][i][j] == 1 else (10000 + Rh4[j * 28 + i]))))
...
for i in range(1, input_len):
    ...
    i, ((10000 + Rd1[i + 500]) if i % 2 == 0 else (900 + Rd2[i + 500])),
    ((900 + Rd2[i + 500]) if i % 2 == 0 else (10000 + Rd1[i + 500]))))
